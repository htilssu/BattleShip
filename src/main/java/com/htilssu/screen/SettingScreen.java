        ...
        if (menuScreen != null) {
            ...
            if (backgroundMusicClip != null) {
                if (isMuted) {
                    ...
                    volumeIconLabel.setIcon(new ImageIcon(AssetUtils.loadAsset("/soundoff.png"))); // Thay đổi hình ảnh khi tắt âm thanh
                } else {
                    backgroundMusicClip.start();
                    volumeIconLabel.setIcon(new ImageIcon(AssetUtils.loadAsset("/soundon.png"))); // Thay đổi hình ảnh khi mở âm thanh
                }
            }
        }
    }
