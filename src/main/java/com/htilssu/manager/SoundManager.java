...
public final class SoundManager {
    ...
    static {
        soundMap.put(BOOM_SOUND, AssetUtils.loadSound("/sounds/A_BoomSound.wav"));
        soundMap.put(DUCK_SOUND, AssetUtils.loadSound("/sounds/A_DuckSound.wav"));
        soundMap.put(PUT_SHIP_SOUND, AssetUtils.loadSound("/sounds/A_PutShipSound.wav"));
        soundMap.put(ATTACK_SOUND, AssetUtils.loadSound("/sounds/A_SoundAttack.wav"));
        soundMap.put(BACKGROUND_TEST, AssetUtils.loadSound("/sounds/A_SoundNen.wav"));
    }
